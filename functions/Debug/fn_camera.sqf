...
//oldui 		_parent createdisplay "RscDisplayCamera";
	} else {
//oldui 		createdialog "RscDisplayCamera"
	};
};
...
switch _mode do {
	...
	case "SliderDaytime": {
		...
		[0,0] setovercast (sliderposition (_display displayctrl 31436));
