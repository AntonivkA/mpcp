...
//oldui 		_displayMission createdisplay "RscDisplayAnimViewer";
	};
};
...
//oldui 	_cursel = lbcursel CONTROL;
//oldui 	_selected = CONTROL lbtext _cursel;
	_cursel = 0;
	_selected = "N/A";
	...
	_idc = _idcNext;
//oldui 	lbclear CONTROL;
	{
//oldui 		CONTROL lbadd _x;	
	} foreach _nextTypes;
//oldui 	lbsort CONTROL;
//oldui 	CONTROL ctrlenable (count _nextTypes > 1);

	//--- Select default item
	_cursel = 0;
	_curselClass = BIS_fnc_animViewer_path select _id;
//oldui 	for "_c" from 0 to (lbsize CONTROL - 1) do {
//oldui 		_class = CONTROL lbtext _c;
//oldui 		if (_class == _curselClass) then {_cursel = _c;};
//oldui 	};
//oldui 	CONTROL lbsetcursel _cursel;
