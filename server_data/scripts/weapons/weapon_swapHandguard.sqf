...
_hasBipod = !isNull(_parent itemInSlot 'weaponBipod');
if (_hasBipod) exitWith
{
	//cant attach
	[_person,format["You must remove %1 first.",displayName (_parent itemInSlot 'weaponBipod')],"colorAction"] call fnc_playerMessage;
};
