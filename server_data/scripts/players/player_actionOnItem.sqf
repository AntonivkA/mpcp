ProfileStart "player_actionOnItem.sqf";
private["_state"];
/*
	...
	case 0:
	{
		...
		*/
		...
		if (_canUseActions == 0) exitWith
		{
			...
			ProfileStop "player_actionOnItem.sqf";
		};
		...
		//_person lockItemToHands _inUse;
		_person setSlotLock ["Hands", true];
		diag_log format ["OnItem:::Lock::: %1", _person getSlotLock "Hands" ];
