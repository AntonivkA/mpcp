...
//oldui 	_ctrl = _display displayCtrl _idc;
//oldui 	{_ctrl lbAdd _x} forEach _array;
//oldui 	_ctrl lbSetCurSel _serial;
//oldui 	_ctrl ctrlCommit 0;
};
_addToCtrl = {
	_idc = _this select 0;
	_item = _this select 1;
//oldui :	(_display displayCtrl _idc) lbAdd _item;
};
...
switch _mode do {
	case "onUnload":
	{
		...
		{
//oldui 			(findDisplay 167) closeDisplay 1;
		};
	};
	case "onLoad":
	{
...
//oldui 		_ctrl = _display displayCtrl 1420;
//oldui 		lbClear _ctrl;
